      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <h5 class="text-uppercase">Iventries</h5>
              </a>
            </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            <h5 class="widget-title text-uppercase mb-4">Halaman</h5>
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
                <a href="#ruangan" class="item-anchor">Ruangan</a>
              </li>
              <li class="menu-item">
                <a href="#tentang" class="item-anchor">Tentang</a>
              </li>
              <li class="menu-item">
                <a href="#barang" class="item-anchor">Barang</a>
              </li>
